        ...
        <>
            {artistImages.length ?
                <div className='main-container my-portfolio-container'
                    id='my-portfolio-container'>
                    <div className='title-container'
                        id='portfolio-title'>
                        <h2 id='my-portfolio-header'>
                            Your Portfolio
                        </h2>
                        <p id='portfolio-text'>
                            Edit tags and delete photos from your portfolio.
                        </p>
                    </div>
                    <div className='all-images-container portfolio-all-images-container'
                        id='my-portfolio-all-images-container'>
                ...
                <div className='empty-portfolio'>
                    <ImageFormModal />
                    <p id='empty-portfolio-text'>
                        Your portfolio's looking a bit bare. Don't be shy! Share your ink.
                    </p>
                </div>
            }
        </>
